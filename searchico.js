...
Searchico.prototype.add = function (haystack) {
    var new_sanitized_data = flatten(haystack, this.config);
    if (this.config.hyper_indexing) {
...
function init (options) {
    var instance = new Searchico(options);
    return instance;
}
